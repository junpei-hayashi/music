...
<div>
    ...
    @if (!$bool)
        <span class="follows">
            <i class="fas fa-duotone fa-user-plus follow-toggle " data-follow-id="{{ $item->id }}"></i>
            <!-- <i class="fas fa-light fa-heart follow-toggle " data-review-id="{{ $item->id }}"></i> -->
        <span class="follow-counter">{{$item->follows_count}}</span>
        </span><!-- /.follows -->
    @else
        <span class="follows">
            <i class="fas fa-duotone fa-user-check follow-toggle followed" data-follow-id="{{ $item->id }}" style="color:red;"></i>
